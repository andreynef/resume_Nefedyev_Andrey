                ...
                body:[
                    {
                        ...
                        about: 'Я начинающий frontend разработчик. Моя цель – сменить род деятельности и поменять круг общения. Мне импонирует это направление в веб разработке, т.к. можно видеть результат своей деятельности. К тому же оно достаточно перспективное. Мне нравится создавать что-то новое и здесь это легко реализовать.                          Поработать и пожить я успел  в разных сферах и странах. Уровень английского advance. Думаю хоть здесь он сгодится, в плане изучения всякой документации                           Оцениваю себя как творческого человека но для начала не помешает и системный подход. В обществе друзей общительный. При деловых встречах предпочитаю краткость и информативность. Не пью и не курю, но не ЗОЖ. В глобальных планах планирую развиться от frontenda до fullstack.'
                    },
                ],
            },
        ],
